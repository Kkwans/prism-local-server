...
class HomeView:
    ...
    def _add_service_card(self, service: ServiceInstance):
        ...
        # 添加到列表
        self._service_list.controls.append(card.container)
    ...
    def _stop_service(self, service_id: str):
            ...
            try:
                ...
                if success:
                    ...
                    if service_id in self._service_cards:
                        ...
                        self._service_list.controls.remove(card.container)
        ...
        dialog = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.Button("停止", on_click=confirm_stop, style=ft.ButtonStyle(
                    bgcolor=ft.Colors.PRIMARY,
                    color=ft.Colors.ON_PRIMARY
                ))
            ],
    ...
    def _show_about(self, e):
        ...
        dialog = ft.AlertDialog(
            ...
            actions=[
                ft.Button("关闭", on_click=close_dialog, style=ft.ButtonStyle(
                    bgcolor=ft.Colors.PRIMARY,
                    color=ft.Colors.ON_PRIMARY
                ))
            ],
